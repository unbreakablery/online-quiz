...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="icon" type="image/png" href="<?php echo $one->assets_folder; ?>/img/favicons/favicon-180x180.png" sizes="180x180">
        <link rel="icon" type="image/png" href="<?php echo $one->assets_folder; ?>/img/favicons/favicon-192x192.png" sizes="192x192">
        <link rel="icon" type="image/png" href="<?php echo $one->assets_folder; ?>/img/favicons/favicon-256x256.png" sizes="256x256">
